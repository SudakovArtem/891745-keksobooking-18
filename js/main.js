...
var getSimilarAdverts = function () {
  ...
  var getMock = function () {
    ...
    for (var i = 0; i < ADVERT_LENGTH; i++) {
      advertArray[i] = {
        'author': {
          'avatar': 'img/avatars/user' + pad(getImageNumber(avatars), 2) + '.png', // строка, адрес изображения вида img/avatars/user{{xx}}.png, где {{xx}} это число от 1 до 8 с ведущим нулём. Например, 01, 02 и т. д. Адреса изображений не повторяются
        },
